...
func makeDwarf() Race {
	...
	myRace := Race{
		Name:        "Dwarf",
		Image:       "https://i.imgur.com/GZJdKlA.jpg",
...
func makeElf() Race {
	...
	myRace := Race{
		Name:        "Elf",
		Image:       "https://i.imgur.com/maeXyH6.jpg",
...
func makeHalfling() Race {
	...
	myRace := Race{
		Name:        "Halfling",
		Image:       "https://i.imgur.com/m367oBX.jpg",
...
func makeHuman() Race {
	...
	myRace := Race{
		Name:        "Human",
		Image:       "https://i.imgur.com/FHs7H2X.jpg",
...
func makeDragonborn() Race {
	...
	myRace := Race{
		Name:        "Dragonborn",
		Image:       "https://i.imgur.com/Yn4PJFB.jpg",
...
func makeGnome() Race {
	...
	myRace := Race{
		Name:        "Gnome",
		Image:       "https://i.imgur.com/cWeZnVF.jpg",
...
func makeHalfElf() Race {
	...
	myRace := Race{
		Name:        "Half-Elf",
		Image:       "https://i.imgur.com/i46mAhr.jpg",
...
func makeHalfOrc() Race {
	...
	myRace := Race{
		Name:        "Half-Orc",
		Image:       "https://i.imgur.com/HwOV02H.jpg",
...
func makeTiefling() Race {
	...
	myRace := Race{
		Name:        "Tiefling",
		Image:       "https://i.imgur.com/FV74DpH.jpg",
